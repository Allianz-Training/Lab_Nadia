...
let student: any = { prop1: true, prop2: "Hello", prop3: 94, prop4: {} }
...
let recArea = (a:number,b:number) => console.log(`Area of regtangle: ${a*b}`)
recArea(2,3);

let primeNumber = (pnumber:number) => {
...
let callIdCard = (type:idCard):void =>{
    console.log(type)
}
let kitty = {
    "Id Number":22222,
...
let callCourse = (type2: course):void =>{
    console.log(type2);
}
const info: information = {courseNo: 12345, credit: 3}
let thai = {
    courseTitle: "Thai",
    information: info
}
...
//Lab2.11
console.log("\n----------Lab2.11-----------");
let genericArr = new Array<number>();
genericArr.push(1);
// genericArr.push("text"); This code returns an error
let genericMap = new Map<string,number>();
